    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col">
                    <h1 style="font-weight:bold !important;" class="h3 mb-3 text-dark">Bienvenido, {{ $user->nombre }} {{ $user->apellido }}</h1>
                    <p class="text-muted mb-2">
                        <span style="font-weight:bold !important;" class="fw-semibold">Vehículo:</span> {{ $user->marca_vehiculo }} {{ $user->modelo_vehiculo }} ({{ $user->anio_vehiculo }})
                    </p>
                    <p class="text-muted small mb-0">
                        <span style="font-weight:bold !important;" class="fw-semibold">Placa:</span> {{ $user->numero_placa }}
                    </p>
                </div>
                <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0 display-5 fw-bold">{{ number_format($user->puntos) }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="card-title mb-0 display-6 fw-bold">{{ $user->numero_placa }}</h3>
                            <p class="small opacity-75 mb-0 mt-1">{{ $user->marca_vehiculo }}</p>
                        </div>
                        <svg class="text-white opacity-50" width="48" height="48" fill="currentColor" viewBox="0 0 20 20">
